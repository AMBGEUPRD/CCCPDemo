...
- [copilot-instructions.md](.github/instructions/copilot-instructions.md) — **Foundational principles (DRY, KISS, YAGNI, SoC, SOLID)**, PEP 8, typing, logging, async, error handling, testing, file size & modularity
- [CLAUDE.md](.claude/CLAUDE.md) — same rules plus agent-specific conventions (prompt construction, Azure AI Foundry patterns)
